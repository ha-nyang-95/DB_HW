...
BUS_API_KEY = "64674f62716173643531547546736e"  # 서울시 버스 교통 데이터 API 키 (빈칸 채우기)
SUBWAY_API_KEY = "64674f62716173643531547546736e"  # 서울시 지하철 교통 데이터 API 키 (빈칸 채우기)
...
def get_bus_data(date):
    ...
    # XML 응답 데이터를 파싱
    root = ET.fromstring(response.content)  # (빈칸 채우기: API 응답 데이터를 XML 형식으로 변환)
